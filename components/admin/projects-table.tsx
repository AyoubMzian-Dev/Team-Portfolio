...
import { Eye, Edit, Trash2, Star, ExternalLink, Github } from "lucide-react"
...
export function ProjectsTable({ projects: initialProjects, onUpdate, onDelete, onToggleFeatured }: ProjectsTableProps) {
  ...
  const handleToggleFeatured = async (projectId: number) => {
    ...
    try {
      // Use parent callback if provided, otherwise handle internally
      if (onToggleFeatured) {
